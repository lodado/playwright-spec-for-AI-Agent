...
spec (.spec.ts)
  ...
  → packages/provider-hermes/index.mjs         full-spec semantic extraction + independent review
...
| `packages/abstract-playwright/index.mjs`                                     | Compose immutable static authority with independently reviewed AI semantics                                                                                                                                                          | abstract/execute CLI                                                                 | AI output may describe applicability, authored flow, and claims; it must never add policy, fixtures, selectors, actions, or verdicts. Cache inputs include source, manifest, model, prompt, and reviewer identity.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| `packages/provider-hermes/index.mjs`                                         | Hermes extraction, applicability, proposer, judge, and reviewer transports/prompts                                                                                                                                                 | abstract/execute/judge/review/remediation CLI                                        | Bump the matching prompt version for every prompt change. Prompts advise; static manifests and runtime authorizers enforce. Applicability failure must preserve execute-all coverage.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
