...
process.exitCode = await runQaNative(process.argv.slice(2), {
  handlers: { execute: executeQaNative, judge: judgeQaNative, diagnose: reportQaNative, "suggest-fix": reportQaNative, report: reportQaNative, "publish-issue": publishIssueQaNative },
});
